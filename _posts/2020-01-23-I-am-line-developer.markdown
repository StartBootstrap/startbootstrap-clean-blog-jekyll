...
이 책은 나의 개발자로서의 삶을 조금은 더 발전시켜줄 것 같아 구매했다. 나는 내가 올바른 방향으로 노력하고 있는지, 그리고 그 노력이 조금 더 나은 결과로 나에게 다가올지 나로써는 도저히 알 수 없다. 그저 지금의 노력이 최선이라고 믿을 수 밖에 없는 멍청이다. 이 책은 내가 좀 더 좋은 선택지를 고르기 위한 나침반이 되주길 원한다.  
