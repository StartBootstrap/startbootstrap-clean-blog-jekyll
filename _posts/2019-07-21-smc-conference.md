...
1 - Fasciani, Stefano, and Vohra., Manohar (2019) "Towards a High-Performance Platform for Sonic Interaction Interfaces." In 16th Sound and Music Computing Conference (SMC 2019).

2 – Cavdir, Doga (2019) “Digital Manufacturing for Musical Applications: A Survey of Current Status and Future Outlook”.  In 16th Sound and Music Computing Conference (SMC 2019).

3 - Michon, Romain, et al. (2019)  "Real Time Audio Digital Signal Processing With Faust and the Teensy." In 16th Sound and Music Computing Conference (SMC 2019).

4 - Keenan, F., and Pauletto, S. (2019). Evaluating a Continuous Sonic Interaction: Comparing a Performable Acoustic and Digital Everyday Sound.” In 16th Sound and Music Computing Conference (SMC 2019).

5 - Panariello, Claudio, Mattias Sköld, Emma Frid, and Roberto Bresin.  (2019) "From vocal sketching to sound models by means of a sound-based musical transcription system." In 16th Sound and Music Computing Conference (SMC 2019).

6 – Çamcı, Anil, (2019) “Exploring the Effects of Diegetic and Non-diegetic Audiovisual Cues on Decision-making in Virtual Reality”.  Sound and Music Computing (SMC).

7 - Passalenti, Andrea, Razvan Paisa, Niels C. Nilsson, Nikolaj S. Andersson, Federico Fontana, Rolf Nordahl, and Stefania Serafin. (2019), "No Strings Attached: Force and Vibrotactile Feedback in a Guitar Simulation"  Sound and Music Computing (SMC).

8 - Johnson, David, Daniela Damian, and George Tzanetakis.  (2019) "OSC-XR: A Toolkit for Extended Reality Immersive Music Interfaces.". Sound and Music Computing (SMC).

9 - Mathiesen, Signe Lund, Derek Victor Byrne, and Qian Janice Wang. (2019), "Sonic Sweetener Mug."  Sound and Music Computing (SMC).

10 -Pecquet, Justin, Fotis Moschos, David Fierro, and Frank Pecquet. (2019), "Performing with Sound Sample-Controlled Gloves and Light-Controlled Arms."  Sound and Music Computing (SMC).

11 - Tuovinen, Joonas, Jamin Hu, and Vesa Välimäki. (2019) "Towards Automatic Tuning of the Piano."  Sound and Music Computing (SMC).

12 - Gibson, Darrell, and Richard Polfreman.  (2019) "A framework for the evaluation of interpolated synthesizer parameter mapping.", Sound and Music Computing (SMC).

13 - Kreković, Gordan.   (2019) "Insights in Habits and Attitudes Regarding Programming Sound Synthesizers: A Quantitative Study.", Sound and Music Computing (SMC).

14 - Damskägg, Eero-Pekka, Lauri Juvela, and Vesa Välimäki. (2019) "Real-Time Modeling of Audio Distortion Circuits with Deep Learning." , Sound and Music Computing (SMC).

15 - Hsu, J., and Tamara Smyth. (2019)  "Percussion Synthesis using Loopback Frequency Modulation Oscillators."  Sound and Music Computing (SMC).

16 - Vinjar, Anders, and Jean Bresson. (2019) "OM-AI: A Toolkit to Support AI-Based Computer-Assisted Composition Workflows in OpenMusic."  Sound and Music Computing (SMC).

17 - Lartillot, Olivier, (2019) “Miningsuite: A Comprehensive Matlab Framework For Signal, Audio and Music Analysis, Articulating Audio And Symbolic Approaches”,, Sound and Music Computing (SMC).
 
18 - Leonard, James, and Jerome Villeneuve. (2019) "MI-GEN~: An Efficient and Accessible Mass-Interaction Sound Synthesis Toolbox" , Sound and Music Computing (SMC).

19 - Landsnes, Kristoffer, Liana Mehrabyan, Victor Wiklund, Robert Lieck, Fabian C. Moss, and Martin Rohrmeier. (2019) "A Model Comparison for Chord Prediction on the Annotated Beethoven Corpus." Sound and Music Computing (SMC).

20 -Grollmisch, Sascha and Cano, Estefania,  (2019) “Automatic Chord Recognition in Music Education Applications”,, Sound and Music Computing (SMC).

21 - P. Martin, Vincent, Reynal, Sylvain, Basaran, Dogac and Crayencour, Hélène-Camille, (2019) “Belief Propagation algorithm for Automatic Chord Estimation” , Sound and Music Computing (SMC).

22 - Nadar, Christon-Ragavan, Jakob Abeßer, and Sascha Grollmisch. (2019), "Towards CNN-based Acoustic Modeling of Seventh Chords for Automatic Chord Recognition."  Sound and Music Computing (SMC).

23 - Pauwels, Johan, and Mark B. Sandler. (2019), "Finding new practice material through chord-based exploration of a large music catalogue."  Sound and Music Computing (SMC).

24 - Schreiber, Hendrik, and Meinard Müller. (2019) "Musical Tempo and Key Estimation using Convolutional Neural Networks with Directional Filters." Sound and Music Computing (SMC).

25 - Colombo, Florian, Brea, Johanni, and Gerstner, Wulfram  (2019), “Learning to Generate Music with BachProp”, Sound and Music Computing (SMC).

26 - Demirel, Emir, Baris Bozkurt, and Xavier Serra. (2019) "Automatic Chord-Scale Recognition using Harmonic Pitch Class Profiles”, , Sound and Music Computing (SMC).

27 - Vassilakis, Dimitrios, Anastasia Georgaki, and Christina Anagnostopoulou. (2019) “Jazz Mapping an Analytical and Computational Approach to Jazz Improvisation."  Sound and Music Computing (SMC).

28 - Hallström, Eric, Simon Mossmyr, Bob Sturm, Victor Vegeborn, and Jonas Wedin.  (2019), "From Jigs and Reels to Schottisar och Polskor: Generating Scandinavian-like Folk Music with Deep Recurrent Networks." Sound and Music Computing (SMC).

29 - Misgeld, Olof, Andre Holzapfel, and Sven Ahlbäck.  (2019) "Dancing Dots-Investigating the Link between Dancer and Musician in Swedish Folk Dance." Sound and Music Computing (SMC).

30 - Wang, Changhong, Emmanouil Benetos, Xiaojie Meng, and Elaine Chew.  (2019), "HMM-based Glissando Detection for Recordings of Chinese Bamboo Flute."  Sound and Music Computing (SMC).

31 - Shafiei, S. (2019). Analysis of Vocal Ornamentation in Iranian Classical Music.

32 - Helena Cuesta, Emilia Gómez and Pritish Chandna (2019). "A Framework for Multi-f0 Modeling in SATB Choirs." In 16th Sound and Music Computing Conference (SMC 2019).